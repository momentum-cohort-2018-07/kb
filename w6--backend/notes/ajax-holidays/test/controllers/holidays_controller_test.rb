...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { name: @holiday.name, observed_on: @holiday.observed_on, origin_country: @holiday.origin_country } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { name: @holiday.name, observed_on: @holiday.observed_on, origin_country: @holiday.origin_country } }
